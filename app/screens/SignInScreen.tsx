...
type SignInScreenNavigationProp = NativeStackNavigationProp<AppStackParamList, "SignIn">
...
export const SignInScreen: FC<SignInScreenProps> = observer(function SignInScreen(_props) {
  ...
  async function trySignIn() {
    ...
    if (emailValidationError() || passwordValidationError() || isLoading) return
    setIsLoading(true)
  ...
  return (
    ...
    >
      ...
      <Text tx="SignInScreen.forgotPassword" preset="hint" style={$forgotPasswordText} />

      <ListItem topSeparator containerStyle={$listItemContainer} textStyle={$listItemText}>
        <Button
