...
type SignUpScreenNavigationProp = NativeStackNavigationProp<AppStackParamList, "SignUp">
...
export const SignUpScreen: FC<SignUpScreenProps> = observer(function SignUpScreen(_props) {
  ...
  const [hasRepeatedPasswordBeenTouched, setHasRepeatedPasswordBeenTouched] = useState(false)
  ...
  function repeatedPasswordValidationError(): TxKeyPath {
    if (!hasRepeatedPasswordBeenTouched && !hasTriedSubmitting) return undefined
    ...
    >
      ...
      {hasSubmitted ? (
        <View style={$accountCreatedView}>
          ...
          <Text tx="SignUpScreen.accountCreated" preset="bold" style={$accountCreatedText} />
        </View>
      ) : (
        <Button
...
const $image: ImageStyle = { marginVertical: spacing.huge, alignSelf: "center" }
